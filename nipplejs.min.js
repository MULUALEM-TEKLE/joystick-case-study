  ...
  return (
    (e = [
      function (t, i, e) {
        ...
        function n(t) {
          u.has(t) && clearTimeout(u.get(t)), u.set(t, setTimeout(t, 100));
        }
        function s(t, i, e) {
        ...
        y
          ...
          (O.prototype.bindEvt = function (t, i) {
            ...
            return (
              ...
              s(t, h[i], e._domHandlers_[i]),
              g[i] && s(t, g[i], e._domHandlers_[i]),
              e
            );
          }),
          (O.prototype.unbindEvt = function (t, i) {
            return (
              ...
              o(t, h[i], this._domHandlers_[i]),
              g[i] && o(t, g[i], this._domHandlers_[i]),
        ...
        (w.prototype = new e()),
          ...
          (w.prototype.stylize = function () {
            ...
            return (
              ...
              c(t.el, e),
              "circle" === this.options.shape && c(t.back, i),
              c(t.front, i),
              this.applyStyles(t),
              this
            );
          ...
          (w.prototype.hide = function (i) {
            ...
            return (
              o.options.dataOnly ||
                ((o.ui.el.style.opacity = o.options.restOpacity),
                ...
                o.options.restJoystick &&
                  ((t = o.options.restJoystick),
                  ((e = {}).x =
                    !0 === t || !1 !== t.x ? 0 : o.instance.frontPosition.x),
                  (e.y =
                    !0 === t || !1 !== t.y ? 0 : o.instance.frontPosition.y),
                  o.setPosition(i, e))),
              o
            );
          }),
        ...
        function T(t, i) {
          ...
          i = getComputedStyle(this.options.zone.parentElement);
          return (
        ...
        (T.prototype = new e()),
          ...
          (T.prototype.createNipple = function (t, i) {
            ...
            return (
              n.dataOnly || (x(t.ui.el, o), x(t.ui.front, t.frontPosition)),
              this.nipples.push(t),
              this.trigger("added " + t.identifier + ":added", t),
              this.manager.trigger("added " + t.identifier + ":added", t),
              this.bindNipple(t),
              t
            );
          }),
          ...
          (T.prototype.onstart = function (e) {
            ...
            return (
              ...
              o.updateBox(),
              l(e, function (t) {
                o.actives.length < i.maxNumberOfNipples
                  ? o.processOnStart(t)
                  : n.type.match(/^touch/) &&
                    (Object.keys(o.manager.ids).forEach(function (i) {
                      var t;
                      Object.values(n.touches).findIndex(function (t) {
                        return t.identifier === i;
                      }) < 0 &&
                        (((t = [e[0]]).identifier = i), o.processOnEnd(t));
                    }),
                    o.actives.length < i.maxNumberOfNipples &&
                      o.processOnStart(t));
              }),
          ...
          (T.prototype.processOnStart = function (i) {
            var e = this,
              ...
              s = { x: i.pageX, y: i.pageY },
              r = e.getOrCreate(o, s);
            r.identifier !== o && e.manager.removeIdentifier(r.identifier),
              (r.identifier = o);
            function d(t) {
              t.trigger("start", t),
                e.trigger("start " + t.id + ":start", t),
                t.show(),
                0 < n && e.pressureFn(i, t, t.identifier),
                e.processOnMove(i);
            }
            if (
              (0 <= (o = e.idles.indexOf(r)) && e.idles.splice(o, 1),
              e.actives.push(r),
              e.ids.push(r.identifier),
              "semi" !== t.mode)
            )
              d(r);
            else {
              if (!(v(s, r.position) <= t.catchDistance))
                return r.destroy(), void e.processOnStart(i);
              d(r);
            }
            return r;
          }),
          ...
          (T.prototype.processOnMove = function (t) {
            ...
            if (
              ((d = t), isNaN(d.buttons) ? 0 !== d.pressure : 0 !== d.buttons)
            ) {
              if (!o)
                return (
              ...
              i.dynamicPage &&
                ((u = o.el.getBoundingClientRect()),
                (o.position = { x: n.x + u.left, y: n.y + u.top })),
                (o.identifier = e);
              ...
              var d,
                ...
                u =
                  ((y = r),
                  (p = (f = o.position).x - y.x),
                  (d = f.y - y.y),
                  Math.atan2(d, p) * (180 / Math.PI)),
                e = b(u),
                f = h / s,
                y = { distance: h, position: r };
              "circle" === o.options.shape
                ? ((g = Math.min(h, s)),
                  ...
                  (a = { x: 0, y: 0 }),
                  (m = b((m = u))),
                  (a.x = d.x - p * Math.cos(m)),
                  (a.y = d.y - p * Math.sin(m)),
                  (m = a))
                : ((a = r),
                  (c = o.position),
                  (l = s),
                ...
                i.follow
                  ? s < h &&
                    ...
                    (o.position.y += l),
                    (o.el.style.top =
                      o.position.y - (this.box.top + n.y) + "px"),
                    (o.el.style.left =
                      o.position.x - (this.box.left + n.x) + "px"),
                    (h = v(r, o.position)))
                  : ((r = m), (h = g));
              var m = r.x - o.position.x,
                g = r.y - o.position.y;
              (o.frontPosition = { x: m, y: g }),
          ...
          (T.prototype.processOnEnd = function (t) {
            ...
            o &&
              ...
              0 <= i.ids.indexOf(o.identifier) &&
                i.ids.splice(i.ids.indexOf(o.identifier), 1),
              0 <= i.actives.indexOf(o) &&
                i.actives.splice(i.actives.indexOf(o), 1),
              /(semi|static)/.test(e.mode)
                ? i.idles.push(o)
                : 0 <= i.nipples.indexOf(o) &&
                  i.nipples.splice(i.nipples.indexOf(o), 1),
              i.manager.unbindDocument(),
              /(semi|static)/.test(e.mode) &&
                (i.manager.ids[t.id] = t.identifier));
          }),
          (T.prototype.onDestroyed = function (t, i) {
            0 <= this.nipples.indexOf(i) &&
              this.nipples.splice(this.nipples.indexOf(i), 1),
              0 <= this.actives.indexOf(i) &&
                this.actives.splice(this.actives.indexOf(i), 1),
              0 <= this.idles.indexOf(i) &&
                this.idles.splice(this.idles.indexOf(i), 1),
              0 <= this.ids.indexOf(i.identifier) &&
